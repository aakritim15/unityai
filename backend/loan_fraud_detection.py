...
# # ---------------------------
# data = pd.read_csv('balanced_loan_data_80_20.csv')
...
# # ---------------------------
# # For each numerical column, add noise with 0 mean and 30% of its standard deviation.
...
# # Inject Label Noise:
# # ---------------------------
# # Flip about 40% of the training labels.
# noise_fraction = 0.4
# np.random.seed(42)
...
# user_input = {}
# # Iterate over each feature in X. For numerical features, we'll attempt to convert the input.
