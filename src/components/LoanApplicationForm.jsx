...
const LoanApplicationForm = ({ loanAmount, onSubmit, onCancel }) => {
  ...
  const [statusMessage, setStatusMessage] = React.useState(""); // for displaying success/error message
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setStatusMessage("There was an error submitting the application.");
      }
    } catch (error) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="yearsWithEmployer" name="yearsWithEmployer" type="number" value={formData.yearsWithEmployer} onChange={handleChange} />
              </div>
              <div className="space-y-2">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="cibilScore" name="cibilScore" type="number" min="300" max="900" value={formData.cibilScore} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="creditUtilization">Credit Utilization Ratio (%)</Label>
                <Input id="creditUtilization" name="creditUtilization" type="number" min="0" max="100" value={formData.creditUtilization} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="creditCardPaymentBehavior">Credit Card Payment Behavior</Label>
                <Input id="creditCardPaymentBehavior" name="creditCardPaymentBehavior" value={formData.creditCardPaymentBehavior} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="numberOfCreditCards">Number of Credit Cards</Label>
                <Input id="numberOfCreditCards" name="numberOfCreditCards" type="number" value={formData.numberOfCreditCards} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="totalCreditLimit">Total Credit Limit</Label>
                <Input id="totalCreditLimit" name="totalCreditLimit" type="number" value={formData.totalCreditLimit} onChange={handleChange} />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Input id="monthlyIncome" name="monthlyIncome" type="number" value={formData.monthlyIncome} onChange={handleChange} required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="totalSavings">Total Savings & Deposits (₹)</Label>
                <Input id="totalSavings" name="totalSavings" type="number" value={formData.totalSavings} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="existingLoans">Existing Loans (Number)</Label>
                <Input id="existingLoans" name="existingLoans" type="number" value={formData.existingLoans} onChange={handleChange} />
              </div>
              <div className="space-y-2">
                <Label htmlFor="dtiRatio">DTI Ratio</Label>
                <Input id="dtiRatio" name="dtiRatio" type="decimal" min="0" max="1" value={formData.dtiRatio} onChange={handleChange} />
              </div>
            </div>
          </div>
